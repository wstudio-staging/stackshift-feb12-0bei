...
(self.webpackChunk_webriq_pagebuilder_site_template_default =
  ...
  [1128, 607],
  {
    ...
    "./components/sections/cookies/variant_c.tsx": (
      __unused_webpack_module,
      __webpack_exports__,
      __webpack_require__
    ) => {
          ...
          showCookie
            ...
            : title &&
                __jsx(
                  ...
                  {
                    className:
                      "max-w-md p-6 px-10 mx-4 mb-6 text-white bg-gray-800 rounded-lg md:mx-0 md:ml-10",
                  },
                  __jsx(
                    "div",
                    { className: "text-center" },
                    __jsx("p", { className: "font-bold font-heading" }, title),
                    block &&
                      __jsx(lib_sanity__WEBPACK_IMPORTED_MODULE_1__.YI, {
                        value: block,
                        components:
      ...
      try {
        (VariantC.displayName = "VariantC"),
          ...
          "undefined" != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              "components/sections/cookies/variant_c.tsx#VariantC"
            ] = {
              docgenInfo: VariantC.__docgenInfo,
              name: "VariantC",
              path: "components/sections/cookies/variant_c.tsx#VariantC",
            });
      } catch (__react_docgen_typescript_loader_error) {}
    },
