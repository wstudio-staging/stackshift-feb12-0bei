...
(self.webpackChunk_webriq_pagebuilder_site_template_default =
  ...
  [28],
  {
    ...
    "./components/sections/navigation/variant_c.tsx": (
      ...
      function VariantC(_ref) {
        ...
        return __jsx(
          ...
          __jsx(
            ...
            __jsx(
              "div",
              { className: "container flex items-center px-4 mx-auto" },
              __jsx(
                "ul",
                {
                  className:
                    "hidden lg:flex lg:w-auto lg:items-center lg:space-x-6",
                },
                links &&
                  (null == links
                    ? void 0
              ...
              __jsx(
                "div",
                { className: "hidden text-right lg:ml-auto lg:block lg:w-1/3" },
          ...
          __jsx(
            ...
            __jsx(
              ...
              __jsx(
                ...
                __jsx(
                  "p",
                  { className: "my-4 text-xs text-center text-gray-700" },
                  __jsx(
                    "span",
                    null,
                    "© ".concat(
        ...
        (VariantC.displayName = "VariantC"),
          ...
          "undefined" != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              "components/sections/navigation/variant_c.tsx#VariantC"
            ] = {
              docgenInfo: VariantC.__docgenInfo,
              name: "VariantC",
              path: "components/sections/navigation/variant_c.tsx#VariantC",
            });
