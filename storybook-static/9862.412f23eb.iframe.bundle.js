...
(self.webpackChunk_webriq_pagebuilder_site_template_default =
  ...
  [9862],
  {
    ...
    "./components/sections/navigation/variant_a.tsx": (
      ...
      function VariantA(_ref) {
        ...
        return __jsx(
          ...
          __jsx(
            ...
            {
              className:
                "relative flex items-center justify-between px-6 py-6 bg-white",
            },
            ...
            (null == secondaryButton ? void 0 : secondaryButton.label) &&
              __jsx(
                components_ui_ConditionalLink__WEBPACK_IMPORTED_MODULE_5__.M,
                {
                  ...
                  className: "hidden lg:inline-block py-2 px-6 bg-"
                    .concat(template.color, "-darkblue hover:bg-")
                    .concat(
                      template.color,
                      "-blue text-sm text-white font-bold rounded-l-xl rounded-t-xl transition duration-200"
                    ),
                },
                null == secondaryButton ? void 0 : secondaryButton.label
              )
                          ...
                          return __jsx(
                            ...
                            __jsx(
                              components_ui_ConditionalLink__WEBPACK_IMPORTED_MODULE_5__.M,
                              {
                                ...
                                ariaLabel: null == link ? void 0 : link.label,
                                className:
                                  "block p-4 text-sm font-semibold text-gray-900 rounded hover:bg-brand-secondary-foreground hover:text-brand-primary",
                                link,
                              },
                              null == link ? void 0 : link.label
                            )
                  ...
                  (null == secondaryButton ? void 0 : secondaryButton.label) &&
                    __jsx(
                      components_ui_ConditionalLink__WEBPACK_IMPORTED_MODULE_5__.M,
                      {
                        ...
                        link: secondaryButton,
                        className:
                          "block px-4 py-3 mb-2 leading-loose text-xs text-center text-white font-semibold bg-"
                            .concat(template.color, "-darkblue hover:bg-")
                            .concat(
                              template.color,
                              "-blue rounded-l-xl rounded-t-xl"
                            ),
                      },
                      null == secondaryButton ? void 0 : secondaryButton.label
                    )
        ...
        (VariantA.displayName = "VariantA"),
          ...
          "undefined" != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              "components/sections/navigation/variant_a.tsx#VariantA"
            ] = {
              docgenInfo: VariantA.__docgenInfo,
              name: "VariantA",
              path: "components/sections/navigation/variant_a.tsx#VariantA",
            });
