...
(self.webpackChunk_webriq_pagebuilder_site_template_default =
  ...
  [5560],
  {
    "./components/sections/pricing/variant_a.tsx": (
      ...
      function VariantA(_ref) {
        var _plans$,
          ...
          _React$useState =
            react__WEBPACK_IMPORTED_MODULE_0__.useState("monthly"),
          _React$useState2 = (0,
          ...
          plan = _React$useState2[0],
          setPlan = _React$useState2[1],
          _React$useState3 = react__WEBPACK_IMPORTED_MODULE_0__.useState(plans),
          _React$useState4 = (0,
          _Users_johnchristophermoreno_Desktop_workspace_webriq_site_template_default_node_modules_storybook_nextjs_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_6__.Z)(
            _React$useState3,
            2
          ),
          usePlan = _React$useState4[0],
          setUsePlan = _React$useState4[1],
          ...
          pKeyError = _React$useState6[0],
          comma = (_React$useState6[1], Intl.NumberFormat("en-us"));
        return (
                                                          ...
                                                          _data$data.forEach(
                                                            function (item) {
                                                              ...
                                                              "month" ===
                                                                ...
                                                                ? (plans[
                                                                    i
                                                                  ].variant_a_monthlyPriceCheckoutButton =
                                                                    item.id)
                                                                : item.product ===
                                                                    productResponse
                                                                      .data
                                                                  ...
                                                                  (plans[
                                                                    i
                                                                  ].variant_a_yearlyPriceCheckoutButton =
                                                                    item.id);
                                                            }
                                                          )),
                                                      setUsePlan(plans),
            ...
            __jsx(
              ...
              __jsx(
                ...
                __jsx(
                  ...
                  void 0 === _plans$
                    ...
                    __jsx(
                      "div",
                      {
                        className: "inline-block px-1 py-1 bg-white rounded-lg",
                      },
                      __jsx(
                        components_ui_Button__WEBPACK_IMPORTED_MODULE_4__.z,
                        {
                          ...
                          className:
                            "mr-1 px-4 py-2 text-sm bg-white hover:bg-white ".concat(
                              "monthly" === plan
                      ...
                      __jsx(
                        components_ui_Button__WEBPACK_IMPORTED_MODULE_4__.z,
                        {
                          ...
                          className:
                            "px-4 py-2 text-sm bg-white hover:bg-white ".concat(
                              "yearly" === plan
                                ? "rounded-lg bg-gray-50 text-gray-900 shadow"
                                : "text-gray-500",
                ...
                __jsx(
                  ...
                  null == usePlan
                    ? void 0
                    : usePlan.map(function (planDetail, index) {
                        var _planDetail$planInclu;
                        return __jsx(
                          "div",
                          {
                            className:
                              "w-full px-4 mb-8 md:w-1/2 lg:mb-5 lg:w-1/3",
                            key: planDetail._key,
                          },
                          __jsx(
                            components_ui_Card__WEBPACK_IMPORTED_MODULE_3__.Z,
                            {
                              className: "p-8 ".concat(
                                index % 2 != 0
                            ...
                            __jsx(
                              ...
                              {
                                className:
                                  "font-heading mb-2 text-2xl font-bold ".concat(
                            ...
                            __jsx(
                              ...
                              null ===
                                (_planDetail$planInclu =
                                  planDetail.planIncludes) ||
                                void 0 === _planDetail$planInclu
                                ? void 0
                                : _planDetail$planInclu.map(function (include) {
                                    return __jsx(
                                      "li",
                                      { className: "flex mb-2", key: include },
                                      __jsx(
                                        "svg",
                                        {
                                          className: "mr-2 h-5 w-5 ".concat(
                                            index % 2 != 0
                                              ? "text-baby-darkblue"
                                              : "text-brand-primary"
                                          ),
                            ...
                            __jsx(
                              components_ui_Button__WEBPACK_IMPORTED_MODULE_4__.z,
                              {
                                ...
                                className:
                                  "inline-block w-full rounded-l-xl rounded-t-xl px-4 py-2 text-center "
                                    .concat(
                                      index % 2 != 0
                                    ...
                                    .concat(
                                      !planDetail ||
                                        ("variant_a_monthlyPriceCheckoutButton" in
                                          planDetail &&
                                          !(
                                            null != planDetail &&
        ...
        (VariantA.displayName = "VariantA"),
          ...
          "undefined" != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              "components/sections/pricing/variant_a.tsx#VariantA"
            ] = {
              docgenInfo: VariantA.__docgenInfo,
              name: "VariantA",
              path: "components/sections/pricing/variant_a.tsx#VariantA",
            });
