...
(self.webpackChunk_webriq_pagebuilder_site_template_default =
  ...
  [4556],
  {
    ...
    "./components/sections/app_promo/variant_c.tsx": (
            ...
            __jsx(
              ...
              __jsx(
                ...
                __jsx(
                  ...
                  __jsx(
                    ...
                    __jsx(
                      ...
                      {
                        className:
                          "mb-5 text-sm font-bold text-left text-brand-primary md:text-lg lg:text-xl",
                      },
                      subtitle
                    ),
                    __jsx(
                      components_ui_Text__WEBPACK_IMPORTED_MODULE_3__.x,
                      {
                        type: "h1",
                        className:
                          "mb-4 text-xl font-bold text-left font-heading md:text-4xl lg:text-5xl",
                      },
                      title
                    ),
                    __jsx(
                      ...
                      {
                        className:
                          "mb-6 text-sm leading-loose text-left text-gray-500 md:text-lg lg:text-xl",
                      },
                      description
                    ),
                    __jsx(
                      ...
                      features &&
                        features.map(function (feature, index) {
                          return __jsx(
                            "li",
                            { className: "flex items-center mb-3", key: index },
                            __jsx(
                              "svg",
                              {
                                className:
                ...
                __jsx(
                  ...
                  {
                    className:
                      "flex items-center w-full transform -rotate-12 lg:w-1/2",
                  },
                  __jsx(
                    "div",
                    { className: "w-full" },
                  ...
                  __jsx(
                    ...
                    { className: "w-full" },
                    null == images ||
                      null === (_images$slice = images.slice(1, 3)) ||
                      void 0 === _images$slice
                      ? void 0
                      : _images$slice.map(function (images, index) {
                          var _images$1$alt, _images$4;
                          return __jsx(
                            next_image__WEBPACK_IMPORTED_MODULE_1__.Z,
                            {
                              ...
                              alt:
                                ...
                                void 0 !== _images$1$alt
                                  ? _images$1$alt
                                  : "appPromo-variantC-image".concat(index),
                              key: index,
                            }
                          );
                        })
                    ...
                    void 0 === _images$5
                      ...
                      __jsx(next_image__WEBPACK_IMPORTED_MODULE_1__.Z, {
                        ...
                        alt:
                          null !==
                            (_images$3$alt =
                              null === (_images$7 = images[3]) ||
                              void 0 === _images$7
                                ? void 0
                                : _images$7.alt) && void 0 !== _images$3$alt
                            ? _images$3$alt
                            : "appPromo-variantC-image4",
                      })
                  )
                )
              )
        ...
        (VariantC.displayName = "VariantC"),
          ...
          "undefined" != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              "components/sections/app_promo/variant_c.tsx#VariantC"
            ] = {
              docgenInfo: VariantC.__docgenInfo,
              name: "VariantC",
              path: "components/sections/app_promo/variant_c.tsx#VariantC",
            });
