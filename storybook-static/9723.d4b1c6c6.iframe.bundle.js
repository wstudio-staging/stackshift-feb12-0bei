...
(self.webpackChunk_webriq_pagebuilder_site_template_default =
  ...
  [9723, 607],
  {
    ...
    "./components/sections/cookies/variant_a.tsx": (
      ...
      __webpack_require__.r(__webpack_exports__),
        __webpack_require__.d(__webpack_exports__, {
          cookiesBlockStyling: () => cookiesBlockStyling,
      ...
      var _Users_johnchristophermoreno_Desktop_workspace_webriq_site_template_default_node_modules_storybook_nextjs_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_4__ =
        ...
        utils_cookies__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__("./utils/cookies.js"),
        components_ui_Button__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
        ...
        cookiesBlockStyling = {
          block: {
            normal: function normal(_ref) {
              ...
              return __jsx(
                "p",
                { className: "my-5 text-sm text-gray-500" },
                children
              );
            },
          },
                ...
                "a",
                {
                  "aria-label":
                    ...
                    void 0 !== _value$href
                      ...
                      : "external link",
                  className:
                    "text-blue-400 hover:text-brand-secondary-foreground",
                  target: "_blank",
                  href: value.href,
      ...
      function VariantA(_ref3) {
        var title = _ref3.title,
          block = _ref3.block,
          allowCookieBtn = _ref3.allowCookieBtn,
          denyCookieBtn = _ref3.denyCookieBtn,
          cookie = (0, utils_cookies__WEBPACK_IMPORTED_MODULE_3__.e)(),
          ...
          showCookie = _React$useState2[0],
          setShowCookie = _React$useState2[1];
        return __jsx(
          "div",
            ...
            : __jsx(
                ...
                (title || block) &&
                  __jsx(
                    ...
                    {
                      className:
                        "flex flex-wrap items-center p-6 mb-6 text-white bg-gray-800 rounded-lg",
                    },
                    __jsx(
                      "div",
                    ...
                    __jsx(
                      "div",
                      { className: "px-4 lg:w-1/3 lg:text-right" },
                      allowCookieBtn &&
                        __jsx(
                          components_ui_Button__WEBPACK_IMPORTED_MODULE_2__.z,
                          {
                            ariaLabel: allowCookieBtn,
                            type: "button",
                            className:
                              "py-2 m-2 border-2 border-brand-primary hover:border-brand-primary-foreground",
                            onClick: function onClick() {
                              (0, utils_cookies__WEBPACK_IMPORTED_MODULE_3__.d)(
                                "allow"
                              ),
                      ...
                      denyCookieBtn &&
                        __jsx(
                          components_ui_Button__WEBPACK_IMPORTED_MODULE_2__.z,
                          {
                            ...
                            type: "button",
                            className:
                              "m-2 font-normal text-white bg-transparent border-2 border-gray-400 rounded-bl-none rounded-r-xl rounded-t-xl hover:bg-gray-700",
                            onClick: function onClick() {
                              (0, utils_cookies__WEBPACK_IMPORTED_MODULE_3__.d)(
                                "dismiss"
                              ),
        ...
        (VariantA.displayName = "VariantA"),
          ...
          "undefined" != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              "components/sections/cookies/variant_a.tsx#VariantA"
            ] = {
              docgenInfo: VariantA.__docgenInfo,
              name: "VariantA",
              path: "components/sections/cookies/variant_a.tsx#VariantA",
            });
      } catch (__react_docgen_typescript_loader_error) {}
    },
    "./components/sections/cookies/variant_d.tsx": (
      __unused_webpack_module,
      __webpack_exports__,
      __webpack_require__
    ) => {
      ...
      var _Users_johnchristophermoreno_Desktop_workspace_webriq_site_template_default_node_modules_storybook_nextjs_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_5__ =
        ...
        lib_sanity__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__("./lib/sanity.ts"),
        utils_cookies__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__("./utils/cookies.js"),
      ...
      function VariantD(_ref) {
        var title = _ref.title,
          block = _ref.block,
          allowCookieBtn = _ref.allowCookieBtn,
          denyCookieBtn = _ref.denyCookieBtn,
          cookie = (0, utils_cookies__WEBPACK_IMPORTED_MODULE_4__.e)(),
          _React$useState = react__WEBPACK_IMPORTED_MODULE_0__.useState(
            !!cookie
          ),
          _React$useState2 = (0,
          ...
          showCookie
            ...
            : title &&
                __jsx(
                  ...
                  {
                    className:
                      "max-w-md py-6 pl-6 pr-16 mx-4 mb-6 text-white bg-gray-800 rounded-lg md:mx-0 md:ml-10 lg:max-w-3xl",
                  },
                  __jsx(
                    "div",
                    ...
                    __jsx(
                      ...
                      block &&
                        __jsx(lib_sanity__WEBPACK_IMPORTED_MODULE_1__.YI, {
                          value: block,
                          components:
                            _variant_a__WEBPACK_IMPORTED_MODULE_2__.cookiesBlockStyling,
                        })
                    ),
                    __jsx(
                      "div",
                      { className: "w-full px-4 lg:w-1/3 lg:text-right" },
                      allowCookieBtn &&
                        __jsx(
                          components_ui_Button__WEBPACK_IMPORTED_MODULE_3__.z,
                          {
                            ...
                            type: "button",
                            className:
                              "mr-4 border-2 border-brand-primary bg-brand-primary hover:border-brand-primary-foreground hover:bg-brand-primary-foreground",
                            onClick: function onClick() {
                              (0, utils_cookies__WEBPACK_IMPORTED_MODULE_4__.d)(
                                "allow"
                              ),
                                setShowCookie(!showCookie);
                            },
                      ...
                      denyCookieBtn &&
                        __jsx(
                          components_ui_Button__WEBPACK_IMPORTED_MODULE_3__.z,
                          {
                            ...
                            type: "button",
                            className:
                              "m-2 text-white bg-transparent border-2 border-gray-400 rounded-bl-none rounded-r-xl rounded-t-xl hover:bg-gray-700",
                            onClick: function onClick() {
                              (0, utils_cookies__WEBPACK_IMPORTED_MODULE_4__.d)(
                                "dismiss"
                              ),
      ...
      try {
        (VariantD.displayName = "VariantD"),
          ...
          "undefined" != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              "components/sections/cookies/variant_d.tsx#VariantD"
            ] = {
              docgenInfo: VariantD.__docgenInfo,
              name: "VariantD",
              path: "components/sections/cookies/variant_d.tsx#VariantD",
            });
      } catch (__react_docgen_typescript_loader_error) {}
    },
    ...
    "./utils/cookies.js": (
      ...
      var name = "dxpstudio-cookieconsent";
