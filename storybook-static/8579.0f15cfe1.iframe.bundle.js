...
(self.webpackChunk_webriq_pagebuilder_site_template_default =
  ...
  [8579],
  {
    ...
    "./components/sections/stats/variant_b.tsx": (
      __unused_webpack_module,
      __webpack_exports__,
      __webpack_require__
    ) => {
          ...
          __jsx(
            ...
            stats &&
              __jsx(
                ...
                {
                  className:
                    "items-center mx-10 sm:justify-left sm:-mx-4 sm:flex sm:flex-wrap",
                },
                null == stats
                  ? void 0
      ...
      try {
        (VariantB.displayName = "VariantB"),
          ...
          "undefined" != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              "components/sections/stats/variant_b.tsx#VariantB"
            ] = {
              docgenInfo: VariantB.__docgenInfo,
              name: "VariantB",
              path: "components/sections/stats/variant_b.tsx#VariantB",
            });
      } catch (__react_docgen_typescript_loader_error) {}
    },
