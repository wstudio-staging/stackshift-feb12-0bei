...
(self.webpackChunk_webriq_pagebuilder_site_template_default =
  ...
  [3879],
  {
    "./components/sections/footer/variant_a.tsx": (
        ...
        return __jsx(
          ...
          __jsx(
            ...
            __jsx(
              ...
              __jsx(
                "div",
                { className: "flex flex-wrap mb-5 lg:mb-20" },
                __jsx(
                  "div",
                  { className: "w-full mb-5 lg:w-1/5" },
                ...
                __jsx(
                  "div",
                  { className: "w-full mb-5 lg:w-1/5" },
                  __jsx("p", { className: "leading-loose text-gray-500" }, text)
                ),
                contacts &&
                  __jsx(
                    "div",
                    {
                      className: "hidden w-full mt-1 ml-auto sm:block lg:w-1/2",
                    },
                    (null == contacts ? void 0 : contacts.length) > 1
                      ? __jsx(
                          "div",
                          {
                          ...
                          __jsx("p", { className: "mb-4 font-bold" }, "Emails"),
                          __jsx("p", { className: "mb-4 font-bold" }, "Numbers")
                        )
                      : __jsx(
                          "div",
                          {
                          ...
                          __jsx("p", { className: "mb-4 font-bold" }, "Email"),
                          __jsx("p", { className: "mb-4 font-bold" }, "Number")
                        ),
                    null == contacts
                      ? void 0
                      : contacts.map(function (contact) {
                          return __jsx(
                            ...
                            {
                              className:
                                "grid grid-flow-col grid-cols-3 gap-10",
                              key: null == contact ? void 0 : contact._key,
                            },
                            __jsx(
                              "p",
                              { className: "mb-5 text-gray-500" },
                              null == contact ? void 0 : contact.addressInfo
                            ),
                            __jsx(
                              "p",
                              { className: "mb-5 text-gray-500" },
                              null == contact ? void 0 : contact.emailInfo
                            ),
                            __jsx(
                              "p",
                              { className: "mb-5 text-gray-500" },
                              null == contact ? void 0 : contact.contactInfo
                            )
                          );
                        })
                  )
              ...
              __jsx(
                "div",
                { className: "justify-between w-full mx-auto lg:flex" },
                __jsx(
                  "p",
                ...
                socialMedia &&
                  __jsx(
                    ...
                    {
                      className:
                        "flex flex-wrap space-x-2 lg:mx-24 lg:space-x-4",
                    },
                    null == socialMedia
                      ? void 0
        ...
        (VariantA.displayName = "VariantA"),
          ...
          "undefined" != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              "components/sections/footer/variant_a.tsx#VariantA"
            ] = {
              docgenInfo: VariantA.__docgenInfo,
              name: "VariantA",
              path: "components/sections/footer/variant_a.tsx#VariantA",
            });
