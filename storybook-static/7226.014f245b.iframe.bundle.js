...
(self.webpackChunk_webriq_pagebuilder_site_template_default =
  ...
  [7226],
  {
    "./components/sections/footer/variant_d.tsx": (
      ...
      var lib_sanity__WEBPACK_IMPORTED_MODULE_1__ =
        ...
        components_ui_SocialIcons__WEBPACK_IMPORTED_MODULE_6__ =
          __webpack_require__("./components/ui/SocialIcons/index.tsx"),
        __jsx = react__WEBPACK_IMPORTED_MODULE_0__.createElement;
      function VariantD(_ref) {
        var _logo$alt,
          logo = _ref.logo,
          multipleMenus = _ref.multipleMenus,
          copyright = _ref.copyright,
          socialMedia = _ref.socialMedia,
          text = _ref.text;
        return __jsx(
          "section",
          { className: "py-10 overflow-hidden bg-gray-50" },
          __jsx(
            "div",
            { className: "container px-4 mx-auto" },
            __jsx(
              "div",
              { className: "flex flex-wrap -mx-4 space-y-4 lg:space-y-0" },
              ((null == logo ? void 0 : logo.image) || text) &&
                __jsx(
                  "div",
                  {
                    className:
                      "flex flex-col w-full max-w-2xl p-4 space-y-4 lg:w-1/4",
                  },
                  (null == logo ? void 0 : logo.image) &&
                    __jsx(
                      ...
                      {
                        className:
                          "inline-block text-xl font-bold leading-none",
                        "aria-label":
                          "/" ===
              ...
              (null == multipleMenus ? void 0 : multipleMenus.length) > 0 &&
                __jsx(
                  "div",
                  {
                    className:
                      "flex flex-wrap flex-grow p-4 -mx-4 lg:justify-around",
                  },
                  null == multipleMenus
                    ? void 0
                    : multipleMenus.map(function (menu) {
                        var _menu$links, _menu$links2;
                        return __jsx(
                          "div",
                          {
                            key: null == menu ? void 0 : menu._key,
                            className: "p-4 w-[200px] flex-none",
                          },
                          (null == menu ? void 0 : menu.title) &&
                            __jsx(
                              "p",
                          ...
                          (null == menu ||
                          null === (_menu$links = menu.links) ||
                          void 0 === _menu$links
                            ? void 0
                            : _menu$links.length) > 0 &&
                            __jsx(
                              "ul",
                              { className: "flex flex-col space-y-2" },
                              null == menu ||
                                null === (_menu$links2 = menu.links) ||
                                void 0 === _menu$links2
                                ? void 0
                                : _menu$links2.map(function (link) {
                                    return __jsx(
                                      "li",
                                      {
                                        key: null == link ? void 0 : link._key,
                                      },
                                      __jsx(
              ...
              socialMedia &&
                __jsx(
                  ...
                  {
                    className:
                      "flex w-full p-4 ml-auto lg:justify-end lg:w-1/6",
                  },
                  null == socialMedia
                    ? void 0
                    : socialMedia.map(function (social) {
                        ...
                        return (
                          (null == social ? void 0 : social.socialMediaLink) &&
                          __jsx(
                            "span",
                            ...
                            __jsx(
                              ...
                              null != social &&
                                ...
                                : __jsx(
                                    components_ui_SocialIcons__WEBPACK_IMPORTED_MODULE_6__.Q,
                                    {
                                      social:
                                        null == social
                                          ? void 0
            ...
            copyright &&
              __jsx(
                "div",
                { className: "pt-10" },
                __jsx("p", { className: "text-sm text-gray-900" }, copyright)
              )
          )
        );
      }
        ...
        (VariantD.displayName = "VariantD"),
          ...
          "undefined" != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              "components/sections/footer/variant_d.tsx#VariantD"
            ] = {
              docgenInfo: VariantD.__docgenInfo,
              name: "VariantD",
              path: "components/sections/footer/variant_d.tsx#VariantD",
            });
