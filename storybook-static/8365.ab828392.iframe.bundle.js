...
(self.webpackChunk_webriq_pagebuilder_site_template_default =
  ...
  [8365],
  {
    ...
    "./components/sections/team/variant_d.tsx": (
        ...
        return __jsx(
          ...
          __jsx(
            ...
            __jsx(
              ...
              __jsx(
                "div",
                { className: "max-w-xl mx-auto mb-8 text-center lg:mb-16" },
                caption &&
                  __jsx(
                    "span",
              ...
              __jsx(
                ...
                team &&
                  team.map(function (member, index) {
                    ...
                    return __jsx(
                      "div",
                      { className: "w-full px-4 mb-6 lg:w-1/2", key: index },
                      __jsx(
                        components_ui_Card__WEBPACK_IMPORTED_MODULE_3__.Z,
                        {
                          className:
                            "items-center p-0 overflow-hidden sm:flex sm:flex-wrap lg:block xl:flex",
                        },
                        ...
                        void 0 === _member$mainImage
                          ...
                          __jsx(
                            ...
                            __jsx(next_image__WEBPACK_IMPORTED_MODULE_1__.Z, {
                              className:
                                "h-[320px] w-full object-cover sm:w-[179px] lg:w-full xl:w-[179px]",
                              sizes: "100vw",
                              src: (0,
                              lib_sanity__WEBPACK_IMPORTED_MODULE_2__.uH)(
                                null == member ||
                                  null ===
                                    (_member$mainImage2 = member.mainImage) ||
                                  void 0 === _member$mainImage2
                                  ? void 0
                                  : _member$mainImage2.image
                              ),
                              width: 179,
                              height: 320,
                              alt:
                                null !==
                                  (_member$mainImage$alt =
                                    null == member ||
                                    null ===
                                      (_member$mainImage3 = member.mainImage) ||
                                    void 0 === _member$mainImage3
                                      ? void 0
                                      : _member$mainImage3.alt) &&
                        ...
                        __jsx(
                          ...
                          {
                            className:
                              "p-4 sm:w-2/3 lg:w-full lg:pl-6 xl:w-2/3",
                          },
                          __jsx(
                            "p",
                            {
                          ...
                          __jsx(
                            ...
                            null == member ? void 0 : member.plainText
                          )
                        )
                      )
                    );
        ...
        (VariantD.displayName = "VariantD"),
          ...
          "undefined" != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              "components/sections/team/variant_d.tsx#VariantD"
            ] = {
              docgenInfo: VariantD.__docgenInfo,
              name: "VariantD",
              path: "components/sections/team/variant_d.tsx#VariantD",
            });
