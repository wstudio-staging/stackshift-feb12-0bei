...
(self.webpackChunk_webriq_pagebuilder_site_template_default =
  ...
  [1839],
  {
    ...
    "./components/sections/features/variant_c.tsx": (
        ...
        return __jsx(
          ...
          __jsx(
            ...
            __jsx(
              ...
              __jsx(
                "div",
                { className: "flex flex-wrap justify-start -mx-3" },
                features &&
                  features.map(function (feature, index) {
                    ...
                    return __jsx(
                      "div",
                      { className: "w-full px-3 mb-6 lg:w-1/2", key: index },
                      __jsx(
                        components_ui_Card__WEBPACK_IMPORTED_MODULE_3__.Z,
                        { className: "flex flex-wrap h-full p-6" },
                        __jsx(
                          "div",
                          null,
                          __jsx(
                            ...
                            {
                              className:
                                "inline-block p-3 mb-4 mr-6 rounded-lg bg-brand-secondary-foreground md:p-5 lg:mb-0",
                            },
                            (null == feature ||
        ...
        (VariantC.displayName = "VariantC"),
          ...
          "undefined" != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              "components/sections/features/variant_c.tsx#VariantC"
            ] = {
              docgenInfo: VariantC.__docgenInfo,
              name: "VariantC",
              path: "components/sections/features/variant_c.tsx#VariantC",
            });
