...
(self.webpackChunk_webriq_pagebuilder_site_template_default =
  ...
  [3571, 607],
  {
    ...
    "./components/sections/cookies/variant_b.tsx": (
      __unused_webpack_module,
      __webpack_exports__,
      __webpack_require__
    ) => {
        ...
        return __jsx(
          ...
          showCookie
            ...
            : title &&
                __jsx(
                  "div",
                  { className: "py-6 text-white bg-gray-800" },
                  __jsx(
                    "div",
                    { className: "container px-4 mx-auto" },
                    __jsx(
                      ...
                      __jsx(
                        "div",
                        { className: "w-full px-4 lg:w-3/4" },
                        __jsx(
                          "p",
                          { className: "font-bold font-heading" },
                          title
                      ...
                      __jsx(
                        "div",
                        { className: "w-full px-4 lg:w-1/4 lg:text-right" },
                        allowCookieBtn &&
                          __jsx(
                            components_ui_Button__WEBPACK_IMPORTED_MODULE_3__.z,
                            {
                              ...
                              type: "button",
                              className:
                                "m-2 border-2 rounded-l-xl rounded-t-xl border-brand-primary bg-brand-primary hover:border-brand-primary-foreground",
                              onClick: function onClick() {
                                (0,
                                utils_cookies__WEBPACK_IMPORTED_MODULE_4__.d)(
                                  "allow"
                                ),
                                  setShowCookie(!showCookie);
                              },
      ...
      try {
        (VariantB.displayName = "VariantB"),
          ...
          "undefined" != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              "components/sections/cookies/variant_b.tsx#VariantB"
            ] = {
              docgenInfo: VariantB.__docgenInfo,
              name: "VariantB",
              path: "components/sections/cookies/variant_b.tsx#VariantB",
            });
      } catch (__react_docgen_typescript_loader_error) {}
    },
