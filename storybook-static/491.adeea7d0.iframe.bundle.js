...
(self.webpackChunk_webriq_pagebuilder_site_template_default =
  ...
  [491],
  {
    ...
    "./components/sections/how_it_works/variant_a.tsx": (
      ...
      function VariantA(_ref) {
        ...
        return (
          video &&
            (videoLinkId = video.includes("embed")
              ? video.split("/")[4]
              : video.split("/watch?v=")[1] || video.split("/")[3]),
          __jsx(
            "section",
            null,
            __jsx(
              ...
              __jsx(
                ...
                __jsx(
                  ...
                  __jsx(
                    "div",
                    { className: "w-full mb-10 lg:mb-0 lg:w-1/2" },
                    __jsx(
                      "div",
                      { className: "max-w-lg mx-10" },
                      __jsx(
                        "span",
                        {
                          className:
                            "text-sm font-bold text-brand-primary md:text-lg lg:text-lg",
                        },
                        subtitle
                      ),
                      __jsx(
                      ...
                      __jsx(
                        ...
                        {
                          className:
                            "text-sm text-gray-500 md:text-lg md:leading-loose lg:text-lg lg:leading-loose",
                        },
                        text
                      )
                    )
                  ...
                  __jsx(
                    ...
                    {
                      className:
                        "relative w-full px-10 lg:h-128 md:h-96 md:w-2/5 md:px-0 lg:w-2/5 lg:px-0",
                    },
                    video &&
                      __jsx("iframe", {
                        ...
                        srcDoc:
                          "<style>*{padding:0;margin:0;overflow:hidden;border-radius:8px}html,body{height:100%}img,span{position:absolute;width:100%;top:0;bottom:0;margin:auto}span{height:1.5em;text-align:center;font:48px/1.5 sans-serif;color:white;text-shadow:0 0 0.5em black}</style><a href=".concat(
                    ...
                    (null == steps
                      ...
                      : steps.map(function (step, index) {
                          return __jsx(
                            ...
                            {
                              className:
                                "w-full px-5 mb-12 md:w-1/2 lg:mb-0 lg:w-1/3",
                              key: index,
                            },
                            __jsx(
                              "span",
                              {
                                className:
                                  "flex items-center justify-center w-12 h-12 mt-6 mb-6 font-bold rounded bg-brand-secondary-foreground text-brand-primary",
                              },
                              index + 1
                            ),
                            __jsx(
                              ...
                              {
                                className:
                                  "mb-2 text-lg font-bold font-heading md:text-2xl lg:text-2xl",
                              },
                              null == step ? void 0 : step.title
                            ),
                            __jsx(
                              "p",
                              {
                                className:
                                  "text-xs text-gray-500 md:text-lg md:leading-loose lg:text-lg lg:leading-loose",
                              },
                              null == step ? void 0 : step.plainText
                            )
                          );
                        }))
                )
          ...
          (VariantA.__docgenInfo = {
            ...
            props: {
              ...
              steps: {
                ...
                name: "steps",
                required: !1,
                type: { name: "ArrayOfTitleAndText[]" },
              },
            },
          }),
          "undefined" != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              "components/sections/how_it_works/variant_a.tsx#VariantA"
            ] = {
              docgenInfo: VariantA.__docgenInfo,
              name: "VariantA",
              path: "components/sections/how_it_works/variant_a.tsx#VariantA",
            });
