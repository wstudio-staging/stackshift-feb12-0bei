...
(self.webpackChunk_webriq_pagebuilder_site_template_default =
  ...
  [4264],
  {
    ...
    "./components/sections/how_it_works/variant_d.tsx": (
                  ...
                  null == steps
                    ...
                    : steps.map(function (step, index) {
                        return __jsx(
                          ...
                          {
                            className:
                              "relative w-full px-10 mt-20 md:w-1/2 lg:mb-0 lg:w-1/3",
                            key: index,
                          },
                          __jsx(
                            "p",
                            {
                              className:
                                "absolute top-0 left-0 ml-10 font-semibold -mt-14 text-9xl text-brand-primary opacity-20",
        ...
        (VariantD.displayName = "VariantD"),
          ...
          "undefined" != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              "components/sections/how_it_works/variant_d.tsx#VariantD"
            ] = {
              docgenInfo: VariantD.__docgenInfo,
              name: "VariantD",
              path: "components/sections/how_it_works/variant_d.tsx#VariantD",
            });
