...
(self.webpackChunk_webriq_pagebuilder_site_template_default =
  ...
  [561],
  {
    "./components/sections/header/variant_e.tsx": (
      ...
      function VariantE(_ref) {
        ...
        return __jsx(
          "section",
          { className: "relative px-10 bg-gray-100" },
          __jsx(
            "div",
                      ...
                      title &&
                        __jsx(
                          ...
                          __jsx(
                            "span",
                            {
                              className: "text-".concat(template.color, "-900"),
                            },
                              ...
                              return __jsx(
                                ...
                                __jsx(
                                  components_ui_ConditionalLink__WEBPACK_IMPORTED_MODULE_1__.M,
                                  {
                                    ...
                                    link,
                                    className:
                                      "underline text-brand-primary hover:text-brand-primary-foreground",
                                  },
                                  null == link ? void 0 : link.label
                                ),
                                index === length - 1
        ...
        (VariantE.displayName = "VariantE"),
          ...
          "undefined" != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              "components/sections/header/variant_e.tsx#VariantE"
            ] = {
              docgenInfo: VariantE.__docgenInfo,
              name: "VariantE",
              path: "components/sections/header/variant_e.tsx#VariantE",
            });
