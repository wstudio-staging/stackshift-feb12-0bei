...
(self.webpackChunk_webriq_pagebuilder_site_template_default =
  ...
  [8121],
  {
    ...
    "./components/sections/testimonials/variant_d.tsx": (
      ...
      var _Users_johnchristophermoreno_Desktop_workspace_webriq_site_template_default_node_modules_storybook_nextjs_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_6__ =
        ...
        components_ui_SwiperButton__WEBPACK_IMPORTED_MODULE_3__ =
      ...
      function VariantD(_ref) {
        var _testimonials$testimo,
          ...
          _testimonials$testimo11,
          _testimonials$testimo12,
          _testimonials$testimo13,
          ...
          slider = function slider(stats) {
            "next" === stats
              ? testimony !==
                (null == testimonials ? void 0 : testimonials.length) - 1
          ...
          __jsx(
            ...
            __jsx(
              ...
              __jsx(
                "div",
                {
                  className: "items-center justify-center md:space-x-8 lg:flex",
                },
                __jsx(
                  "div",
                  ...
                  (null == testimonials ? void 0 : testimonials.length) > 1 &&
                    __jsx(
                      components_ui_SwiperButton__WEBPACK_IMPORTED_MODULE_3__.L,
                      {
                        type: "left",
                ...
                (null == testimonials ? void 0 : testimonials.length) > 1 &&
                  __jsx(
                    "button",
                    {
                      ...
                      className:
                        "hidden p-5 transition duration-200 bg-white rounded-full shadow-md text-brand-primary hover:text-brand-secondary focus:outline-none lg:mr-0 lg:block",
                      onClick: function onClick() {
                        return slider("prev");
                      },
                    },
                ...
                (null == testimonials ? void 0 : testimonials[testimony]) &&
                  __jsx(
                    ...
                    void 0 === _testimonials$testimo
                      ? void 0
                      : _testimonials$testimo.rating) &&
                      __jsx(
                        "div",
                        {
                          className:
                            "w-full py-10 text-center border-r lg:w-1/3",
                        },
                        __jsx(
                          "span",
                        ...
                        __jsx(
                          ...
                          {
                            className:
                              "flex justify-center mb-6 text-brand-primary",
                          },
                          "1" ===
                            (null == testimonials ||
                            null ===
                            ...
                            : "2" ===
                              ...
                              void 0 === _testimonials$testimo4
                                ? void 0
                                : _testimonials$testimo4.rating)
                            ? [1, 2].map(function (rate) {
                                return __jsx(
                                  "svg",
                                  {
                                    key: rate,
                            ...
                            : "3" ===
                              ...
                              void 0 === _testimonials$testimo5
                                ? void 0
                                : _testimonials$testimo5.rating)
                            ? [1, 2, 3].map(function (rate) {
                                return __jsx(
                                  "svg",
                                  {
                                    key: rate,
                            ...
                            : "4" ===
                              ...
                              void 0 === _testimonials$testimo6
                                ? void 0
                                : _testimonials$testimo6.rating)
                            ? [1, 2, 3, 4].map(function (rate) {
                                return __jsx(
                                  "svg",
                                  {
                                    key: rate,
                        ...
                        __jsx(
                          ...
                          {
                            className:
                              "object-contain w-32 h-24 mx-auto mb-6 rounded-full",
                          },
                          (null ===
                            (_testimonials$testimo7 =
                              testimonials[testimony]) ||
                          ...
                          null ===
                            (_testimonials$testimo7 =
                              _testimonials$testimo7.mainImage) ||
                          void 0 === _testimonials$testimo7
                            ? void 0
                            : _testimonials$testimo7.image) &&
                            __jsx(next_image__WEBPACK_IMPORTED_MODULE_1__.Z, {
                              ...
                              lib_sanity__WEBPACK_IMPORTED_MODULE_2__.uH)(
                                null ===
                                  ...
                                  null ===
                                    (_testimonials$testimo8 =
                                      _testimonials$testimo8.mainImage) ||
                                  void 0 === _testimonials$testimo8
                                  ? void 0
                                  : _testimonials$testimo8.image
                              ),
                              width: 128,
                              height: 96,
                              alt:
                                null !==
                                  (_testimonials$testimo9 =
                                    ...
                                    null ===
                                      (_testimonials$testimo10 =
                                        _testimonials$testimo10.mainImage) ||
                                    void 0 === _testimonials$testimo10
                                      ? void 0
                                      : _testimonials$testimo10.alt) &&
                                void 0 !== _testimonials$testimo9
                                  ? _testimonials$testimo9
                                  : "testimonial-source-profile-image".concat(
                                      testimony
                                    ),
                            })
                        )
                    ...
                    __jsx(
                      "div",
                      { className: "w-full px-6 py-10 lg:w-2/3" },
                      __jsx(
                        "svg",
                        {
                      ...
                      __jsx(
                        ...
                        null ===
                          (_testimonials$testimo11 = testimonials[testimony]) ||
                          void 0 === _testimonials$testimo11
                          ? void 0
                          : _testimonials$testimo11.testimony
                      ),
                      __jsx(
                        "p",
                        { className: "text-2xl font-bold font-heading" },
                        null ===
                          (_testimonials$testimo12 = testimonials[testimony]) ||
                          void 0 === _testimonials$testimo12
                          ? void 0
                          : _testimonials$testimo12.name
                      ),
                      __jsx(
                        components_ui_Text__WEBPACK_IMPORTED_MODULE_5__.x,
                        { muted: !0 },
                        null ===
                          (_testimonials$testimo13 = testimonials[testimony]) ||
                          void 0 === _testimonials$testimo13
                          ? void 0
                          : _testimonials$testimo13.jobTitle
                      )
                    )
                  ),
                (null == testimonials ? void 0 : testimonials.length) > 1 &&
                  __jsx(
                    "button",
                    {
                      ...
                      className:
                        "hidden p-5 transition duration-200 bg-white rounded-full shadow-md text-brand-primary hover:text-brand-secondary focus:outline-none lg:block",
                      onClick: function onClick() {
                        return slider("next");
                      },
                    },
        ...
        (VariantD.displayName = "VariantD"),
          ...
          "undefined" != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              "components/sections/testimonials/variant_d.tsx#VariantD"
            ] = {
              docgenInfo: VariantD.__docgenInfo,
              name: "VariantD",
              path: "components/sections/testimonials/variant_d.tsx#VariantD",
            });
