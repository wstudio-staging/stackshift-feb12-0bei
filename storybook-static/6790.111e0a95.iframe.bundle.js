...
(self.webpackChunk_webriq_pagebuilder_site_template_default =
  ...
  [6790],
  {
    ...
    "./components/sections/how_it_works/variant_c.tsx": (
                  ...
                  (null == steps
                    ...
                    : steps.map(function (step, index) {
                        return __jsx(
                          ...
                          {
                            className:
                              "w-full px-4 mt-8 md:w-1/2 lg:mb-0 lg:w-1/3",
                            key: index,
                          },
                          __jsx(
                            ...
                            __jsx(
                              ...
                              {
                                className:
                                  "inline-flex items-center justify-center w-16 h-16 mb-6 text-2xl font-bold rounded bg-brand-secondary-foreground text-brand-primary",
                              },
                              index + 1
                            ),
                            __jsx(
        ...
        (VariantC.displayName = "VariantC"),
          ...
          "undefined" != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              "components/sections/how_it_works/variant_c.tsx#VariantC"
            ] = {
              docgenInfo: VariantC.__docgenInfo,
              name: "VariantC",
              path: "components/sections/how_it_works/variant_c.tsx#VariantC",
            });
