...
(self.webpackChunk_webriq_pagebuilder_site_template_default =
  ...
  [6103],
  {
    "./components/sections/pricing/variant_c.tsx": (
                                                          ...
                                                          _data$data.forEach(
                                                            function (item) {
                                                              ...
                                                              "month" ===
                                                                ...
                                                                ? (plans[
                                                                    i
                                                                  ].variant_c_monthlyPriceCheckoutButton =
                                                                    item.id)
                                                                : item.product ===
                                                                    productResponse
                                                                      .data
                                                                  ...
                                                                  (plans[
                                                                    i
                                                                  ].variant_c_yearlyPriceCheckoutButton =
                                                                    item.id);
                                                            }
                                                          )),
                                                      setUsePlan(plans),
              ...
              __jsx(
                    ...
                    __jsx(
                      ...
                      __jsx(
                        "button",
                        {
                          ...
                          className: "mr-1 px-4 py-2 text-sm ".concat(
                            "monthly" === plan
                      ...
                      __jsx(
                        "button",
                        {
                          ...
                          className: "px-4 py-2 text-sm ".concat(
                            "yearly" === plan
                              ? "rounded-lg bg-gray-50 text-gray-900 shadow"
                              : "text-gray-500",
                            " font-bold focus:outline-none"
                ...
                __jsx(
                  ...
                  usePlan &&
                    (null == usePlan
                      ? void 0
                      : usePlan.map(function (planDescription, index) {
                          return __jsx(
                            "div",
                            {
                              className:
                                "w-full px-4 mb-8 md:w-1/2 lg:mb-8 lg:w-1/3",
                              key: index,
                            },
                            __jsx(
                              ...
                              {
                                className:
                                  "max-w-md px-10 py-8 mx-auto text-center ",
                              },
                              __jsx(
                                "div",
                                { className: "mb-12" },
                              ...
                              __jsx(
                                ...
                                __jsx(
                                  components_ui_Button__WEBPACK_IMPORTED_MODULE_3__.z,
                                  {
                                    ...
                                    className: "mt-6 block w-full ".concat(
                                      !planDescription ||
                                        (!(
                                          null != planDescription &&
        ...
        (VariantC.displayName = "VariantC"),
          ...
          "undefined" != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              "components/sections/pricing/variant_c.tsx#VariantC"
            ] = {
              docgenInfo: VariantC.__docgenInfo,
              name: "VariantC",
              path: "components/sections/pricing/variant_c.tsx#VariantC",
            });
