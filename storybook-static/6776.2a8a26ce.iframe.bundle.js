...
(self.webpackChunk_webriq_pagebuilder_site_template_default =
  ...
  [6776, 607],
  {
    ...
    "./components/sections/cookies/variant_e.tsx": (
      __unused_webpack_module,
      __webpack_exports__,
      __webpack_require__
    ) => {
          ...
          showCookie
            ...
            : title &&
                __jsx(
                  ...
                  {
                    className:
                      "mx-4 mb-6 max-w-md rounded-lg bg-gray-800 pt-8 text-white md:mx-0 md:ml-10",
                  },
                  __jsx(
                    "div",
                    { className: "px-8 text-center" },
                    __jsx("p", { className: "font-heading font-bold" }, title),
                    block &&
                      __jsx(lib_sanity__WEBPACK_IMPORTED_MODULE_1__.YI, {
                        value: block,
                        components:
                  ...
                  __jsx(
                    "div",
                    { className: "flex border-t border-gray-700 text-center" },
                    denyCookieBtn &&
                      __jsx(
                        "button",
                        {
                          ...
                          type: "button",
                          className:
                            "inline-block w-1/2 rounded-bl-lg border-r border-gray-700 py-4 text-sm font-bold transition duration-200 hover:bg-gray-700",
                          onClick: function onClick() {
                            (0, utils_cookies__WEBPACK_IMPORTED_MODULE_3__.d)(
                              "dismiss"
                            ),
                    ...
                    allowCookieBtn &&
                      __jsx(
                        "button",
                        {
                          ...
                          type: "button",
                          className:
                            "inline-block w-1/2 rounded-br-lg py-4 text-sm font-bold text-brand-secondary-foreground transition duration-200 hover:bg-brand-secondary",
                          onClick: function onClick() {
                            (0, utils_cookies__WEBPACK_IMPORTED_MODULE_3__.d)(
                              "allow"
                            ),
      ...
      try {
        (VariantE.displayName = "VariantE"),
          ...
          "undefined" != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              "components/sections/cookies/variant_e.tsx#VariantE"
            ] = {
              docgenInfo: VariantE.__docgenInfo,
              name: "VariantE",
              path: "components/sections/cookies/variant_e.tsx#VariantE",
            });
      } catch (__react_docgen_typescript_loader_error) {}
    },
