...
(self.webpackChunk_webriq_pagebuilder_site_template_default =
  ...
  [3636, 8526],
  {
    ...
    "./components/sections/text_component/variant_b.tsx": (
      __unused_webpack_module,
      __webpack_exports__,
      __webpack_require__
    ) => {
            ...
            __jsx(
              ...
              firstColumn &&
                __jsx(
                  ...
                  {
                    className:
                      "mb-3 px-5 text-justify text-xs leading-relaxed text-gray-500 lg:mb-6 lg:w-1/4 lg:text-base",
                  },
                  __jsx(lib_sanity__WEBPACK_IMPORTED_MODULE_1__.YI, {
                    value: firstColumn,
                    components:
              ...
              secondColumn &&
                __jsx(
                  ...
                  {
                    className:
                      "mb-6 px-5 text-justify text-xs leading-relaxed text-gray-500 md:mb-0 lg:w-1/4 lg:text-base",
                  },
                  __jsx(lib_sanity__WEBPACK_IMPORTED_MODULE_1__.YI, {
                    value: secondColumn,
                    components:
      ...
      try {
        (VariantB.displayName = "VariantB"),
          ...
          "undefined" != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              "components/sections/text_component/variant_b.tsx#VariantB"
            ] = {
              docgenInfo: VariantB.__docgenInfo,
              name: "VariantB",
              path: "components/sections/text_component/variant_b.tsx#VariantB",
            });
      } catch (__react_docgen_typescript_loader_error) {}
    },
    "./lib/config.ts": (
