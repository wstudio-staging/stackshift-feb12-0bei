...
(self.webpackChunk_webriq_pagebuilder_site_template_default =
  ...
  [4673],
  {
    ...
    "./components/sections/how_it_works/variant_e.tsx": (
          ...
          __jsx(
            ...
            __jsx(
              ...
              steps &&
                __jsx(
                  "div",
                  { className: "relative flex flex-wrap mx-auto" },
                  null == steps
                    ? void 0
                    : steps.map(function (step, index) {
                        return __jsx(
                          "div",
                          {
                            ...
                            key: null == step ? void 0 : step._key,
                          },
                          __jsx(
                            "span",
                            {
                              className:
                                "relative z-10 flex items-center justify-center w-16 h-16 mx-auto mb-6 text-2xl text-white rounded-full bg-brand-primary lg:mb-10",
                            },
                            index + 1
                          ),
                          __jsx(
        ...
        (VariantD.displayName = "VariantD"),
          ...
          "undefined" != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              "components/sections/how_it_works/variant_e.tsx#VariantD"
            ] = {
              docgenInfo: VariantD.__docgenInfo,
              name: "VariantD",
              path: "components/sections/how_it_works/variant_e.tsx#VariantD",
            });
