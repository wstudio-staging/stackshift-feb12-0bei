...
(self.webpackChunk_webriq_pagebuilder_site_template_default =
  ...
  [4311],
  {
    "./components/sections/footer/variant_c.tsx": (
        ...
        return __jsx(
          ...
          __jsx(
            ...
            __jsx(
              ...
              __jsx("div", { className: "w-1/3 py-1 bg-brand-secondary" }),
              __jsx("div", {
                className: "w-1/3 py-1 bg-brand-primary-foreground",
              }),
              __jsx("div", { className: "w-1/3 py-1 bg-brand-primary" })
            ),
            __jsx(
              "div",
              { className: "flex w-1/3" },
          ...
          __jsx(
            ...
            __jsx(
              ...
              __jsx(
                ...
                {
                  className:
                    "relative flex flex-wrap mb-8 lg:border-b lg:border-gray-300 lg:pb-8",
                },
                __jsx(
                  "p",
                  {
                    className:
                      "order-last w-full text-sm text-center text-gray-900 lg:order-first lg:w-auto lg:text-left",
                  },
                  copyright
                ),
                menu &&
                  __jsx(
                    ...
                    {
                      className:
                        "mx-auto mb-6 lg:absolute lg:left-1/2 lg:mb-0 lg:-translate-x-1/2 lg:transform",
                    },
                    __jsx(
                      "ul",
                      {
                        className:
                          "flex flex-wrap items-center justify-between mx-20 lg:space-x-5",
                      },
                      null == menu
                        ? void 0
                        : menu.map(function (links, index) {
                            return __jsx(
                              "li",
                              {
                ...
                __jsx(
                  ...
                  {
                    className:
                      "order-first w-full mb-12 text-center lg:order-last lg:mb-0 lg:ml-auto lg:w-auto lg:text-left",
                  },
              ...
              socialMedia &&
                __jsx(
                  ...
                  {
                    className:
                      "flex flex-wrap justify-center space-y-2 sm:space-y-0",
                  },
                  null == socialMedia
                    ? void 0
        ...
        (VariantC.displayName = "VariantC"),
          ...
          "undefined" != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              "components/sections/footer/variant_c.tsx#VariantC"
            ] = {
              docgenInfo: VariantC.__docgenInfo,
              name: "VariantC",
              path: "components/sections/footer/variant_c.tsx#VariantC",
            });
