...
(self.webpackChunk_webriq_pagebuilder_site_template_default =
  ...
  [5145],
  {
    ...
    "./components/sections/navigation/variant_d.tsx": (
          ...
          __jsx(
            ...
            __jsx(
              ...
              __jsx(
                ...
                {
                  className:
                    "hidden lg:flex lg:w-auto lg:items-center lg:space-x-5",
                },
                links &&
          ...
          __jsx(
            ...
            __jsx(
              ...
              __jsx(
                  ...
                  (null == secondaryButton ? void 0 : secondaryButton.label) &&
                    __jsx(
                      components_ui_ConditionalLink__WEBPACK_IMPORTED_MODULE_5__.M,
                      {
                        ...
                        link: secondaryButton,
                        className:
                          "block px-4 py-3 mb-3 text-xs font-semibold leading-loose text-center text-white bg-brand-primary hover:bg-brand-primary-foreground rounded-l-xl rounded-t-xl",
                      },
                      null == secondaryButton ? void 0 : secondaryButton.label
                    )
                ),
                __jsx(
                  "p",
                  { className: "my-4 text-xs text-center text-gray-500" },
                  __jsx(
                    "span",
                    null,
                    "© ".concat(
        ...
        (VariantD.displayName = "VariantD"),
          ...
          "undefined" != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES[
              "components/sections/navigation/variant_d.tsx#VariantD"
            ] = {
              docgenInfo: VariantD.__docgenInfo,
              name: "VariantD",
              path: "components/sections/navigation/variant_d.tsx#VariantD",
            });
