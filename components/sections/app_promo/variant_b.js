          ...
          <div className="lg:flex lg:flex-wrap lg:mx-4">
            <div className="w-full lg:w-1/2 px-4">
              <div className="mt-8 max-w-xl">
                ...
                <p className="mt-3 text-center md:text-left lg:text-left mb-10 text-gray-500 leading-loose break-words">
                  {description}
                </p>
            ...
            <div className="flex sm:flex-wrap items-center justify-center w-full lg:w-1/2 xl:w-1/2 2xl:w-1/2">
              {images &&
                (images.length > 1 ? (
                  <>
                    <button
                      aria-label="Left Arrow button"
                      className="hidden sm:inline-block order-0 md:order-0 lg:order-0 xl:order-1 2xl:order-1 mx-2 md:mr-12 lg:mr-12 xl:mr-12 2xl:mr-12 p-2 md:p-4 lg:p-4 xl:p-4 2xl:p-4 bg-white rounded-full shadow text-webriq-darkblue hover:text-webriq-babyblue focus:outline-none"
                    ...
                    <div className="order-1 md:order-1 lg:order-1 xl:order-0 2xl:order-0 mr-2 object-contain w-1/2">
                      {images?.[currentPosition]?.image && (
                        <Image
                          className="w-full mx-auto mb-8 xl:mb-0 object-cover"
                    ...
                    <button
                      ...
                      className="hidden sm:inline-block order-2 md:ml-12 lg:ml-12 xl:ml-12 2xl:ml-12 p-2 md:p-4 lg:p-4 xl:p-4 2xl:p-4 bg-white rounded-full shadow text-webriq-darkblue hover:text-webriq-babyblue focus:outline-none"
