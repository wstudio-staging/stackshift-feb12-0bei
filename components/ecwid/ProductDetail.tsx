...
import { EcwidTypes } from "context/_types";
    ...
    <>
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4 flex flex-col">
          ...
          <div className="flex w-full flex-row justify-between rounded border border-gray-400 shadow hover:border-gray-500">
            <button
              className="flex h-[44px] w-[44px] items-center justify-center text-xl text-gray-400"
              type="button"
