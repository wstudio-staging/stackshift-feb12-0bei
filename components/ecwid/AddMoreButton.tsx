      ...
      <div className="flex flex-col gap-y-4 ">
        <div className="flex flex-col gap-y-4 sm:flex-row sm:gap-x-4 sm:gap-y-0">
          <div className="w-full">
            <button
              type="submit"
              className="font-heading block w-full rounded-md border border-primary px-8 py-5 text-center font-bold uppercase text-primary transition duration-200"
        ...
        <a
          className="font-heading block w-full rounded-md bg-primary px-8 py-5 text-center font-bold uppercase text-white transition duration-200"
